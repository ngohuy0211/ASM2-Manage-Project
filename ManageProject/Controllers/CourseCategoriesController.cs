...
namespace ManageProject.Controllers
{
    public class CourseCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CourseCategoryID,CourseCategoryName,CourseCategoryDetail")] CourseCategory courseCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseCategoryID,CourseCategoryName,CourseCategoryDetail")] CourseCategory courseCategory)
        {
            if (ModelState.IsValid)
            {
