...
namespace ManageProject.Controllers
{
    public class TopicsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopicID,TopicName,TopicDetail")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopicID,TopicName,TopicDetail")] Topic topic)
        {
            if (ModelState.IsValid)
            {
